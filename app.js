...
function multiplyArray(testArray){ //eslint-disable-line
  var theProduct = multiply(testArray[0],testArray[1],testArray[2]);
  console.log(theProduct);
  var messageProduct = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + theProduct + '.';
  console.log(messageProduct);
  return[theProduct, messageProduct];
}
